...
public class ContactHandler implements ContactListener {
	...
	public void beginContact(Contact contact) {
		// 0 = ground, 1 = player, 2 = spikes, 3 = dynamic spikes, 4 = cubes, 5
		// = slomo, 6 = super jump, 7 = flag
		Fixture a = contact.getFixtureA();
		Fixture b = contact.getFixtureB();

		if ((returnData(a, 1) && returnData(b, 2))
				|| (returnData(a, 2) && returnData(b, 1))) {
			BaseLevel.endTime = System.nanoTime();
			BaseLevel.highScore = BaseLevel.endTime - BaseLevel.startTime;
			BaseLevel.highScore /= 1000000000;
